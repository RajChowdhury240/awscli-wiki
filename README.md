...
### 7. List OIDC Identity Providers
aws iam list-open-id-connect-providers

### 8. Get OIDC Identity Provider Information
aws iam get-open-id-connect-provider --open-id-connect-provider-arn <oidc-provider-arn>

### 9. Delete OIDC Identity Provider
...
### 2. Start Logging for a CloudTrail
aws cloudtrail start-logging --name <trail-name>

### 3. Stop Logging for a CloudTrail
aws cloudtrail stop-logging --name <trail-name>

### 4. Delete a CloudTrail
aws cloudtrail delete-trail --name <trail-name>

### 5. Describe a CloudTrail
aws cloudtrail describe-trails --trail-name-list <trail-name>

### 6. List all CloudTrails
aws cloudtrail list-trails

### 7. Get CloudTrail Status
aws cloudtrail get-trail-status --name <trail-name>

### 8. Lookup CloudTrail Events
...
### 6. Delete a Lambda Function
aws lambda delete-function --function-name <function-name>

### 7. Get Lambda Function Details
aws lambda get-function --function-name <function-name>

### 8. List Versions of a Lambda Function
